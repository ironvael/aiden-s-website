      ...
      <main className="pt-28 pb-24">
        ...
        <div className="relative">
          ...
          <header className="px-6 md:px-12 lg:px-24">
            <div className="max-w-5xl mx-auto pt-12 pb-10">
              ...
              <p className="mt-5 text-lg md:text-xl leading-relaxed text-muted-foreground max-w-3xl">
                {thought.excerpt}
              </p>
        ...
        <article className="px-6 md:px-12 lg:px-24">
          <div className="max-w-5xl mx-auto">
            {/* No “paper” card = more open, premium blog feel */}
            <div
              className="
                prose max-w-none
            ...
            >
              <ReactMarkdown
                ...
                components={{
                  ...
                  p: ({ children, ...props }) => (
                    <p {...props} className="text-[18px] leading-8 text-muted-foreground mb-6 max-w-3xl">
                      {children}
                    </p>
                  ),
                  ul: ({ children, ...props }) => (
                    <ul {...props} className="my-6 space-y-2 max-w-3xl">
                      {children}
                    </ul>
                  ),
                  ol: ({ children, ...props }) => (
                    <ol {...props} className="my-6 space-y-2 max-w-3xl">
                      {children}
                    </ol>
                  ),
                  li: ({ children, ...props }) => (
                  ...
                  blockquote: ({ children, ...props }) => (
                    <blockquote
                      {...props}
                      className="my-10 pl-6 border-l-2 border-primary/40 text-foreground/90 max-w-3xl"
                    >
                      <div className="text-xl md:text-2xl font-display leading-snug">{children}</div>
                    </blockquote>
                  ),
                  code: ({ children, ...props }) => (
                    <code {...props} className="rounded-md bg-muted px-1.5 py-0.5 text-[13px] border border-border">
                      {children}
                    </code>
                  ),
                  pre: ({ children, ...props }) => (
                  ...
                  hr: (props) => <hr {...props} className="my-10 border-border max-w-3xl" />,
                }}
              >
                {thought.content}
              </ReactMarkdown>
